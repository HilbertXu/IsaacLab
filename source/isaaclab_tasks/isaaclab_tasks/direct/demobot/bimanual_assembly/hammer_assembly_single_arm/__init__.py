...
task_entry = "isaaclab_tasks.direct.demobot.bimanual_assembly.hammer_assembly_single_arm"


gym.register(
    id="Single-Arm-Hammer-Assembly-Async-v0",
...
gym.register(
    id="Single-Arm-Hammer-Assembly-Async-Asymmetric-v0",
    entry_point=f"{task_entry}.env:HammerAssemblyEnv",
    disable_env_checker=True,
    kwargs={
...
################################################################
gym.register(
    id="Single-Arm-Assembly-Baseline-ours",
    entry_point=f"{task_entry}.env:HammerAssemblyEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Single-Arm-Assembly-Baseline-no-reach",
    entry_point=f"{task_entry}.env:HammerAssemblyEnv",
    disable_env_checker=True,
    kwargs={
...
################################################################
gym.register(
    id="Single-Arm-Assembly-Baseline-no-clip",
    entry_point=f"{task_entry}.env:HammerAssemblyEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Single-Arm-Assembly-Baseline-wref-pos-woreach",
    entry_point=f"{task_entry}.env:HammerAssemblyEnv",
    disable_env_checker=True,
    kwargs={
...
################################################################
gym.register(
    id="Single-Arm-Assembly-Baseline-no-prior",
    entry_point=f"{task_entry}.env:HammerAssemblyEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Single-Arm-Assembly-Baseline-woref-vel-woreach",
    entry_point=f"{task_entry}.env:HammerAssemblyEnv",
    disable_env_checker=True,
    kwargs={
...
################################################################
gym.register(
    id="Single-Arm-Assembly-Baseline-woref-pos-wreach",
    entry_point=f"{task_entry}.env:HammerAssemblyEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Single-Arm-Assembly-Baseline-woref-pos-woreach",
    entry_point=f"{task_entry}.env:HammerAssemblyEnv",
    disable_env_checker=True,
    kwargs={
...
##############################################################################
gym.register(
    id="Single-Arm-Assembly-Baseline-no-chunk",
...
######################################################################################
gym.register(
    id="Single-Arm-Assembly-Baseline-no-reset",
    entry_point=f"{task_entry}.env:HammerAssemblyEnv",
    disable_env_checker=True,
    kwargs={
