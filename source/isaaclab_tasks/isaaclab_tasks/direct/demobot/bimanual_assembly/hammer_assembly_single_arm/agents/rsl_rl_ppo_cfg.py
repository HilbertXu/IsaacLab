...
class HammerAssemblyPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    wandb_kwargs = {
        'entity': 'hilbertxu',
        'project': 'demobot-hammer-assembly-single-arm',
        'run_name': 'base'
    }
...
class OursPPORunnerCfg_wref_vel_wreach(HammerAssemblyPPORunnerCfg):
    experiment_name = "single-arm-assembly-ours"
    wandb_kwargs = {
        'entity': 'hilbertxu',
        'project': 'single-arm-baseline-comparison-full',
        'run_name': 'ours'
    }

@configclass
class BaselinePPORunnerCfg_wref_vel_woreach(HammerAssemblyPPORunnerCfg):
    experiment_name = "single-arm-assembly-wref-vel-woreach"
    wandb_kwargs = {
        'entity': 'hilbertxu',
        'project': 'single-arm-baseline-comparison-full',
        'run_name': 'w/o reach'
...
class BaselinePPORunnerCfg_wref_pos_wreach(HammerAssemblyPPORunnerCfg):
    experiment_name = "single-arm-assembly-wref-pos-wreach"
    wandb_kwargs = {
        'entity': 'hilbertxu',
        'project': 'single-arm-baseline-comparison-full',
        'run_name': 'w/o clip'
...
class BaselinePPORunnerCfg_wref_pos_woreach(HammerAssemblyPPORunnerCfg):
    experiment_name = "single-arm-assembly-wref-pos-woreach"
    wandb_kwargs = {
        'entity': 'hilbertxu',
        'project': 'single-arm-baseline-comparison',
...
class BaselinePPORunnerCfg_woref_vel_wreach(HammerAssemblyPPORunnerCfg):
    experiment_name = "single-arm-assembly-woref-vel-wreach"
    wandb_kwargs = {
        'entity': 'hilbertxu',
        'project': 'single-arm-baseline-comparison-full',
        'run_name': 'w/o motion priors'
    }

@configclass
class BaselinePPORunnerCfg_woref_vel_woreach(HammerAssemblyPPORunnerCfg):
    experiment_name = "single-arm-assembly-woref-vel-woreach"
    wandb_kwargs = {
        'entity': 'hilbertxu',
        'project': 'single-arm-baseline-comparison',
...
class BaselinePPORunnerCfg_woref_pos_wreach(HammerAssemblyPPORunnerCfg):
    experiment_name = "single-arm-assembly-woref-pos-wreach"
    wandb_kwargs = {
        'entity': 'hilbertxu',
        'project': 'single-arm-baseline-comparison',
...
class BaselinePPORunnerCfg_woref_pos_woreach(HammerAssemblyPPORunnerCfg):
    experiment_name = "single-arm-assembly-woref-pos-woreach"
    wandb_kwargs = {
        'entity': 'hilbertxu',
        'project': 'single-arm-baseline-comparison',
...
class BaselinePPORunnerCfg_wref_vel_wreach_nochunk(HammerAssemblyPPORunnerCfg):
    experiment_name = "single-arm-assembly-wref-vel-wreach-nochunk"
    wandb_kwargs = {
        'entity': 'hilbertxu',
        'project': 'single-arm-baseline-comparison-full',
        'run_name': 'w/o chunk'
...
class BaselinePPORunnerCfg_wref_vel_wreach_noreset(HammerAssemblyPPORunnerCfg):
    experiment_name = "single-arm-assembly-wref-vel-wreach-noreset"
    wandb_kwargs = {
        'entity': 'hilbertxu',
        'project': 'single-arm-baseline-comparison-full',
        'run_name': 'w/o reset'
