...
from isaaclab_assets import FRANKA_ALLEGRO_LEFT_HIGH_PD_CFG  # isort:skip
...
class HammerAssemblyEnvBaseCfg(DirectRLEnvCfg):
    ...
    viewer: ViewerCfg = ViewerCfg(eye=(1.5, 0.0, 0.9), lookat=(0.8, 0.0, 0.5), resolution=(640, 480))
    ...
    right_object_cfg: RigidObjectCfg = RigidObjectCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            ...
            visual_material=sim_utils.PreviewSurfaceCfg(diffuse_color=(0.9, 0.9, 0.0)),
            scale=(1., 1., 1.),
        ),
    ...
    # robot
    robot_cfg: ArticulationCfg = FRANKA_ALLEGRO_LEFT_HIGH_PD_CFG.replace(prim_path="/World/envs/env_.*/Robot")
    ...
    palm_config: FrameTransformerCfg = FrameTransformerCfg(
        # source frame
        prim_path="/World/envs/env_.*/Robot/base_link",
        debug_vis=False,
        # visualizer_cfg=VisualizationMarkersCfg(
    ...
    # replay buffer
    replay_buffer = 'devel/data/realsense/single_arm_v2_fps30/trajectory_franka_allegro.pkl'
